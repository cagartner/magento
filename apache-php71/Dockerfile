...
# Create new user
RUN useradd -m -p `mkpasswd "cagartner"` -s /bin/bash cagartner && adduser cagartner sudo && ln -s /var/www/html /home/cagartner/html && echo "alias php-debug='php -d xdebug.remote_autostart=1'" > /home/cagartner/.bash_aliases
